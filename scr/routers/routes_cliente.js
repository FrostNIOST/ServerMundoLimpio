...
router.get('/clientes/empresas', clientes_controller.empresas);         //mostrar la lista de las empresas  segun filtro  empresa PK (id), nit, nombre y/o especialidad (esp) /*dejar en empresa*/
